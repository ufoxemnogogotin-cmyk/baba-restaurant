            ...
            <div className="relative flex flex-col items-center justify-center w-full max-w-5xl h-full">
                ...
                >
                  ...
                  <div className="absolute bottom-4 md:bottom-8 left-6 md:left-10 right-6 md:right-10 flex justify-between items-center">
                    ...
                    <p className="text-[#212121]/30 text-[11px] md:text-[13px] font-black uppercase tracking-[0.4em]"> 
                  ...
                  <div className="absolute -bottom-16 left-0 w-full flex justify-center gap-6 md:hidden">
                    ...
                    <button onClick={nextImg} className="bg-white/10 backdrop-blur-md border border-white/20 text-white w-12 h-12 rounded-full flex items-center justify-center active:scale-90 transition-all">
                ...
                <button onClick={nextImg} className="hidden md:flex absolute -right-24 bg-white/5 hover:bg-white/10 text-white w-16 h-16 rounded-full items-center justify-center transition-all">
