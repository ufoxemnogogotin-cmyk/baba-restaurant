...
export default function KitchenGallery() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative z-30 bg-[#F5F2ED] lg:h-[350vh] min-h-[100dvh] pt-10 pb-5 lg:py-0"
    >
      <div className="relative lg:sticky top-0 h-full lg:h-screen w-full flex flex-col lg:flex-row items-center justify-center">
        ...
        <div className="container mx-auto w-full flex flex-col lg:flex-row items-center justify-between z-10">
          ...
          {/* TEXT */}
          <div className="w-full lg:w-[45%] flex flex-col items-center lg:items-start text-center lg:text-left px-6 mb-4 lg:mb-0">
          ...
          <div className="w-full lg:w-[45%] relative">
            ...
            {/* MOBILE */}
            <div className="block lg:hidden w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
              <div
                onScroll={handleMobileScroll}
                className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-4 px-[10vw] pb-8"
              >
                {dishes.map((dish) => (
                  <div
                    key={dish.id}
                    className="snap-center shrink-0 w-[80vw] bg-white p-2 pb-10
                    shadow-[0_20px_50px_-25px_rgba(0,0,0,0.18)]"
                  >
                ...
                {dishes.map((_, i) => (
                  <div
                    ...
                    className={`h-[1px] transition-all duration-500 ${
                      activeIndex === i ? "w-8 bg-[#722F37]" : "w-3 bg-[#212121]/10"
                    }`}
                  />
                ))}
              </div>
            ...
            <div className="hidden lg:flex relative h-[80vh] w-full items-center justify-end">
              {dishes.map((dish, index) => (
                <div
                  ...
                  className="absolute w-[400px] bg-white p-4 pb-20
                  shadow-[0_25px_60px_rgba(0,0,0,0.14)] origin-bottom"
                >
