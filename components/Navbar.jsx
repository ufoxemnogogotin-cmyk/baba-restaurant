      ...
      <header>
        ...
        <AnimatePresence>
          {scrolled && !isOpen && !isTransitioning && (
            ...
            >
              {/* FIXED: Removed h-16 from parent, added h-16 to children. 
                 This allows the parent to grow with the safe-area padding without squashing the content. */}
              <div className="grid grid-cols-5 bg-[#F5F2ED] border-t border-[#212121]/10 pb-[env(safe-area-inset-bottom)]">
