        ...
        <AnimatePresence>
          {scrolled && !isOpen && !isTransitioning && (
            <motion.div 
              ...
              // ПРОМЯНА: Слагаме bg-white и padding тук, на главния контейнер.
              className="lg:hidden fixed bottom-0 left-0 w-full z-[110] bg-white pb-[env(safe-area-inset-bottom)]"
            >
              ...
              <div className="grid grid-cols-5 h-auto bg-[#F5F2ED] border-t border-[#212121]/10">
                ...
                <Link 
                  ...
                  // ПРОМЯНА: Фиксирано h-16, без h-auto, без padding-bottom
                  className="col-span-1 flex flex-col border-r border-[#212121]/5 bg-white active:bg-gray-100 h-16"
                >
                ...
                <Link 
                  href="/reservation" 
                   // ПРОМЯНА: Фиксирано h-16
                  className="col-span-3 flex flex-col bg-white group active:bg-[#212121] transition-colors duration-300 h-16"
                >
                  <div className="h-full w-full flex items-center justify-center">
                ...
                <a 
                  ...
                  rel="noopener noreferrer" 
                   // ПРОМЯНА: Фиксирано h-16
                  className="col-span-1 flex flex-col bg-white border-l border-[#212121]/5 active:bg-gray-100 h-16"
                >
                  <div className="h-full w-full flex items-center justify-center">
